...
TransformComponent::TransformComponent() { this->pos = new Vec2D(0.0f, 0.0f); }
...
float TransformComponent::get_speed() const { return this->speed; }

void TransformComponent::set_speed(const float speed) { this->speed = speed; }

void TransformComponent::update() {}

Vec2D& TransformComponent::get_pos() const { return *this->pos; }
